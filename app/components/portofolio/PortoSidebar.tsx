          ...
          {categories.map((cat) => (
            <li key={cat.name}>
              <Link
                ...
                className="flex justify-between p-3 rounded-md hover:bg-gray-800/50 transition"
              >
                <span>{cat.name}</span>
        ...
        <div className="flex flex-wrap gap-2">
          {tags.map((tag) => (
            <Link
              ...
              className="px-4 py-2 text-sm bg-gray-800 rounded-full hover:bg-gray-700 transition"
            >
              {tag}
            </Link>
          ))}
