// file: app/components/blog/create-post.tsx

"use client";
// Perhatikan perubahan impor: React, useState, useEffect, dan useActionState
...
// Custom upload adapter... (tetap sama)
...
const CreatePost: React.FC = () => {
  ...
  const editorConfiguration: CKEditorConfig = {
    // ... konfigurasi editor Anda tetap sama
  ...
  return (
    <div className="container mt-10">
      ...
      <form action={formAction}>
        {/* ... sisa dari JSX form Anda tetap sama ... */}
        <div className="">
